            ...
            <form name="qaw-8" action="QAW8">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <p class="parrafo col-lg-6 col-md-8 col-sm-12">
                        con el tiempo restante asignado al taller, se procederá a refinar los primeros 4 o 5 
                        escenarios que serán los más importantes del sistema; para este proceso se debe especificar:
                    </p>
                    <div class="col-lg-3 col-md-2"></div>
                </div>
                ...
                <input type="submit" value="Refinar" name="btnQaw8Refinar" class="btn btn-primary"/>
...
<<<<<<< .mine
            ...
            <form name="qaw-8" action="QAW8" method="post" enctype="multipart/form-data">
                ...
                <input type="submit" value="subir archivo" name="btnQawsubir" class="btn btn-primary"/>
            </form>
            ...
            <form name="qaw-8" action="QAW8">    
                <table width="100" border="0">
                    <tbody>
                        <tr>
                            <td class="alIzq"><input type="submit" value="Regresar" name="btnQaw8anterior" class="btn btn-primary"/></td>
                            <td class="alDer"><input type="submit" value="Inicio" name="btnQaw8Inicio" class="btn btn-primary"/></td>
