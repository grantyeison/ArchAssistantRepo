        ...
        <div class="col-lg-12 col-md-12 col-md-12">
            <form name="add-4" action="ADD4">
                            ...
                            <tbody>
                                        ...
                                        for (Tactica tac : listaTac) {
                                            ...
                                            if (tacAtributo != null) {
                                                if (tacAtributo.getAcID() == atr.getAcID()) {
                                                    ...
                                                    out.println("</td>");
                                                    out.println("<td>" + listadoPat + tac.getTacID());
                                ...
                                <tr>
                                    <td colspan="3" class="alDer">
                                        <input class="btn btn-primary" type="button" value="Guardar Seleccion" name="btnGuardarSeleccion" id="btnGuardarSeleccion"/>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                ...
                                <%List<Patron> listaPat = archB.ListarPatronesT();
                                    ...
                                    for (Patron pat : listaPat) {
                                        ...
                                        //out.println("</td>");
                                        out.println("<td>");
                                        out.println("<input  type = 'checkbox' name = 'tacticaSel' id='chkTac' value = '" + pat.getPatID() + "'/>");
                                        //out.println(mod.getModId());
                                        out.println("</td>");
                        ...
                        <from namr="add-4" action="ADD4">
                            ...
                            <table class="tblCentContent">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <textarea name="descMod" value="" placeholder="Descripcion Modulo" class="form-control"></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                ...
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <textarea rows="5" cols="120" name="ratadd4" class="form-control parrafo"><%session.setAttribute(
                                "paso", "add4");
