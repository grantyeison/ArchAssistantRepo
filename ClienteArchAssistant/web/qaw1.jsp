                        ...
                        <%
                            ...
                            if (archivos != null)
                            {
                                for(File archivo : archivos)
                                {
                                    ...
                                    out.print("<td class='alDer'>"+"<input type=\"submit\" value=\"Eliminar\" name=\"btnQawEliminar"+archivo.getName()+"\" class=\"btn btn-primary\"/>        ");
                                    out.print("<input type=\"submit\" value=\"Descargar\" name=\"btnQawBajar"+archivo.getName()+"\" class=\"btn btn-primary\"/>"+"</td>");
                                    out.print("</tr>");
                                }
                            }
                         %>
